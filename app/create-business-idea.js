                    ...
                    <View style={styles.marketDataContainer}>
                      <View style={styles.marketDataItem}>
                        ...
                        <Text style={styles.marketDataValue}>
                          {analysis.marketAnalysis.marketData.companiesCount.toLocaleString()}
                        </Text>
                      </View>
                      ...
                      <View style={styles.marketDataItem}>
                        ...
                        <Text style={styles.marketDataValue}>
                          {analysis.marketAnalysis.marketData.marketGrowth}%
                        </Text>
                      </View>
                      ...
                      <View style={styles.marketDataItem}>
                        ...
                        <Text style={styles.marketDataValue}>
                          {analysis.marketAnalysis.marketData.investmentVolume}
                        </Text>
                      </View>
                      ...
                      <View style={styles.marketDataItem}>
                        ...
                        <Text style={styles.marketDataValue}>
                          {analysis.marketAnalysis.marketData.avgCompanyValue}
                        </Text>
                      </View>
                  ...
                  <Surface style={styles.analysisSectionSurface}>
                    ...
                    <View style={styles.urgencyDataContainer}>
                      <View style={styles.urgencyDataRow}>
                        ...
                        <View style={styles.urgencyDataItem}>
                          ...
                          <Text style={styles.urgencyDataValue}>
                            {analysis.urgencyAnalysis.growthRate}
                          </Text>
                        </View>
                      </View>
                      ...
                      <View style={styles.urgencyDataRow}>
                        <View style={styles.urgencyDataItem}>
                          ...
                          <Text style={styles.urgencyDataValue}>
                            {analysis.urgencyAnalysis.disruptionRisk}
                          </Text>
                        </View>
                        ...
                        <View style={styles.urgencyDataItem}>
                          ...
                          <Text style={styles.urgencyDataValue}>
                            {analysis.urgencyAnalysis.timeToMarket}
                          </Text>
                        </View>
                      </View>
                    </View>
                    ...
                    <Text style={styles.urgencyExplanation}>
                      {analysis.urgencyAnalysis.trend === 'Acelerada' ? 
                        `Con una tendencia ${analysis.urgencyAnalysis.trend.toLowerCase()} y un riesgo de disrupción ${analysis.urgencyAnalysis.disruptionRisk.toLowerCase()}, este mercado se está moviendo rápidamente. Es recomendable actuar con prontitud en un plazo de ${analysis.urgencyAnalysis.timeToMarket}.` :
                        analysis.urgencyAnalysis.trend === 'Creciente' ? 
                        `La tendencia ${analysis.urgencyAnalysis.trend.toLowerCase()} y un crecimiento de ${analysis.urgencyAnalysis.growthRate} indican una ventana de oportunidad favorable, con un tiempo estimado al mercado de ${analysis.urgencyAnalysis.timeToMarket}.` :
                        `Con una tendencia ${analysis.urgencyAnalysis.trend.toLowerCase()} y un riesgo de disrupción ${analysis.urgencyAnalysis.disruptionRisk.toLowerCase()}, hay tiempo suficiente para desarrollar una estrategia óptima en un plazo de ${analysis.urgencyAnalysis.timeToMarket}.`}
                    </Text>
                  </Surface>
                        ...
                        <Card.Content>
                          ...
                          <View style={styles.companyDetailsContainer}>
                            ...
                            <View style={styles.companyDetailItem}>
                              ...
                              <Text style={styles.companyDetailValue}>{company.employees}</Text>
                            </View>
                            
                            <View style={styles.companyDetailItem}>
                              <Text style={styles.companyDetailLabel}>Ingresos:</Text>
                              <Text style={styles.companyDetailValue}>{company.revenue}</Text>
                            </View>
                          </View>
