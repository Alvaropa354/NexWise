...
import { Text, Surface, Divider, Button, IconButton, Badge, Avatar, Card, Chip, Appbar, Portal, FAB } from 'react-native-paper';
...
export default function ProfileScreen({ navigation }) {
  ...
  const { hideFAB } = useContext(FABContext);
  ...
  // Ocultar FABs al entrar en la pantalla de perfil
  useEffect(() => {
